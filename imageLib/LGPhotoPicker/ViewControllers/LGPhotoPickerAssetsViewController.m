...
//        rightBtn.contentEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 10);
        rightBtn.frame = CGRectMake(0, 0, 80, 45);
...
//        leftBtn.contentEdgeInsets = UIEdgeInsetsMake(0, 10, 0, 0);
        leftBtn.frame = CGRectMake(0, 0, 80, 45);
...
- (void) cancelBtnTouched{
    [[NSNotificationCenter defaultCenter] postNotificationName:PICKER_TAKE_CANCEL object:nil userInfo:@{@"selectAssets":self.selectAssets,@"isOriginal":@(self.isOriginal)}];
