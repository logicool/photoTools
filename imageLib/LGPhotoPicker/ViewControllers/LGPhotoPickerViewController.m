...
- (void) addNotification{
    ...
    // 监听异步cancel通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(cancel:) name:PICKER_TAKE_CANCEL object:nil];
}
